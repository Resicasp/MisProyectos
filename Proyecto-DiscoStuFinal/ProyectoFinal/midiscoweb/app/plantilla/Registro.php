...
<html>
	...
	<section><br>
		...
		<form action='../../index.php'>
			Usuario(id): <input name="iduser" type="text" required><br>
			Nombre: <input name="nombre" type="text" required><br>
			Contraseña: <input name="contra" type="text" required><br>
			Repita contraseña: <input name="contra2" type="text" required><br>
			...
			<select name="tipouser">
				...
				<option value="3" disabled>Máster</option>
			</select> <br>
