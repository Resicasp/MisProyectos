...
$rutasUser = [
    ...
    "Modificar Mis Datos"   => "ctlUserModificar2",
	"Actualizar Datos"   => "ctlUserActualizar",
    "Actualizar"   => "ctlUserActualizar2",
	...
	"Crear Fichero" => "ctlUserAltaFichero3",
	"file" => "ctlFileDownload",
    "file2" => "ctlFileDownloadShare",
    "fileshare" => "ctlFileDescargaDirecta",
];
